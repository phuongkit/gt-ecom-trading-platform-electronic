...
function SearchInput(props) {
    ...
    let {content: resultSearch, ...page} = useSelector((state) => state.search.pageSearch.data);
    ...
    const hanleClickSearch = (e) => {
        ...
        hideResultSearch();
        navigate(`/search?keyword=${getValue}`);
        // navigate(`tim-kiem`);
        // }
        // if (url !== null) {
        //     hideResultSearch();
    ...
    return (
        <div className="w-[54%]">
            ...
            <form className="relative outline-none" onSubmit={hanleClickSearch}>
                ...
                <Tippy
                    interactive
                    visible={showResult && resultSearch && resultSearch.length > 0}
                    duration={50}
