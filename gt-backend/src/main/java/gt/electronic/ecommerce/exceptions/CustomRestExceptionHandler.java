...
//  //  MethodArgumentNotValidException – This exception is thrown when an argument annotated with
...
//  }
//
//  //  MissingServletRequestPartException – This exception is thrown when the part of a multipart
//  // request is not found.
//  //  MissingServletRequestParameterException – This exception is thrown when the request is missing
//  // a parameter
...
//  }
//
//  //  TypeMismatchException – This exception is thrown when trying to set bean property with the
//  // wrong type.
...
//  }
//
//  //  handle HttpMediaTypeNotSupportedException, which occurs when the client sends a request with unsupported media type
...
//  }
//
//  @ExceptionHandler(ResourceNotFoundException.class) protected ResponseEntity<Object> handlerResourceNotFoundException(
//      RuntimeException ex, WebRequest request) {
//    ApiError apiError = new ApiError(HttpStatus.NOT_FOUND, ex.getLocalizedMessage(), "error occurred");
//    return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
//  }
//
//  @ExceptionHandler(ResourceNotFound.class) @ResponseStatus(HttpStatus.OK) @ResponseBody protected ResponseObject<?> handlerExceptionInGetRequest(
//      RuntimeException ex, WebRequest request) {
//    return new ResponseObject<>(HttpStatus.NOT_FOUND, ex.getMessage(), null);
//  }
//
////  @ExceptionHandler({AccessDeniedException.class}) @ResponseStatus(HttpStatus.OK) @ResponseBody protected ResponseObject<?> handleUNAUTHORIZEDException(
////      Exception ex, WebRequest request) {
////    return new ResponseObject<>(HttpStatus.UNAUTHORIZED, ex.getLocalizedMessage(), null);
////  }
////
...
////  }
//
//  @ExceptionHandler({FileException.class, InvalidFieldException.class, UserNotPermissionException.class}) @ResponseStatus(HttpStatus.BAD_REQUEST) @ResponseBody protected ResponseObject<?> handleResourceAlreadyExistsException(
//      RuntimeException exception) {
//    return new ResponseObject<>(HttpStatus.OK, exception.getMessage(), null);
//  }
//
//  //  a fallback handler — a catch-all type of logic that deals with all other exceptions that don't have specific handlers
////  @ExceptionHandler({Exception.class}) public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
