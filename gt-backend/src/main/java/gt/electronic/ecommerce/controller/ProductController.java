...
public class ProductController {
  ...
  @GetMapping("")
  public ResponseObject<Page<ProductGalleryDTO>> getAllProduc(
    ...
    return new ResponseObject<>(
        HttpStatus.OK, "",
        this.productService.getAllProductCategoryIdAndBrandId(brandId,
                                                              categoryId,
                                                              shopId,
                                                              locationString,
                                                              sortOption,
  ...
  public ResponseObject<Page<ProductGalleryDTO>> getAllProduct(
    ...
    return new ResponseObject<>(
        ...
        keyword, brandName, categoryName, shopName, locationString, minPrice, maxPrice, pageable));
  }
  ...
  public ResponseObject<ProductResponseDTO> createProduct(
    ...
    return new ResponseObject<>(HttpStatus.CREATED, String.format(Utils.CREATE_OBJECT_SUCCESSFULLY, branchName),
                                this.productService.createProduct(loginKey, creationDTO, imageFile, imageFiles, isAdmin));
  }
  ...
  public ResponseObject<ProductResponseDTO> updateProduct(
    ...
    return new ResponseObject<>(HttpStatus.OK, String.format(Utils.UPDATE_OBJECT_SUCCESSFULLY, branchName),
                                this.productService.updateProduct(loginKey, id, creationDTO, imageFile, imageFiles, isAdmin));
  }
