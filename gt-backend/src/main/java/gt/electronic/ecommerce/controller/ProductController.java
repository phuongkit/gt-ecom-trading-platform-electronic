...
public class ProductController {
  ...
  public ResponseObject<Page<ProductGalleryDTO>> getAllProduct(
    ...
    return new ResponseObject<>(
        ...
        keyword, brandName, categoryName, shopName, locationString, sortOption, minPrice, maxPrice, pageable));
  }
  ...
  public ResponseObject<ProductResponseDTO> createProduct(
    ...
    isAdmin =
        isAdmin ? isAdmin : SecurityContextHolder.getContext().getAuthentication().getAuthorities().toString().contains(
