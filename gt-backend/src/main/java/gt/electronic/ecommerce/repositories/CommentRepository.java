...
public interface CommentRepository extends JpaRepository<Comment, Long> {
  ...
  @Query(
      value =
          "select c from Comment c where c.commentType = gt.electronic.ecommerce.models.enums.ECommentType.COMMENT "
  ...
  @Query(
      value =
          "select c from Comment c where c.commentType = gt.electronic.ecommerce.models.enums.ECommentType.FEEDBACK "
