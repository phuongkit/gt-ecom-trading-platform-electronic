...
public class ShopMapperImpl implements ShopMapper {
  ...
  @Override public ShopResponseDTO shopToShopResponseDTO(Shop entity) {
    if (entity == null) {
      return null;
    }
    ...
    responseDTO.setAddress(addressMapper.lineAndLocationToAddressResponseDTO(entity.getLine(), entity.getLocation()));
  ...
  @Override public ShopSimpleResponseDTO shopToShopSimpleResponseDTO(Shop entity) {
    if (entity == null) {
      return null;
    }
