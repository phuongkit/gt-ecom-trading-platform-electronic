...
//  private final List<String> allowedOrigins = Arrays.asList("http://127.0.0.1:5173", "http://127.0.0.1:5000");
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    response.setHeader("Access-Control-Allow-Headers", "Authorization, Content-Type, Accept, X-Requested-With, remember-me, x-auth-token");
...
//    }
    ...
    //If the token is verified, update the authentication context with the user details ID and phone.
