...
public class FeedbackServiceImpl implements FeedbackService {
    ...
    public FeedbackResponseDTO createFeedback(
        ...
        if (mainFeedbackFound == null) {
            ...
            feedback.setSentiment(creationDTO.getSentiment() != null ?
                                          ESentiment.getESentimentFromString(creationDTO.getSentiment()) : null);
            ...
            if (imageGalleryFile != null && imageGalleryFile.length > 0) {
                ...
                for (MultipartFile multipartFile : imageGalleryFile) {
                    if (!multipartFile.isEmpty()) {
                        Image image =
                                this.imageService.createImageByMultipartFile(multipartFile, EImageType.IMAGE_FEEDBACK);
