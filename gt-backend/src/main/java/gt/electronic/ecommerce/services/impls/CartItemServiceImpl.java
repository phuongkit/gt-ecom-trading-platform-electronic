...
public class CartItemServiceImpl implements CartItemService {
    ...
    public List<OrderDetailResponseDTO> getAllCartItemByUser(String loginKey, Long userId, Pageable pageable) {
        ...
        List<OrderItem> cartItemList =
                this.orderItemRepo.findByUserAndStatus(userFound, EOrdertemStatus.UN_PAID, pageable);
    ...
    public OrderDetailResponseDTO createCartItem(String loginKey, CartItemCreationDTO creationDTO) {
        ...
        if (cartItemFound == null) {
            ...
            cartItemFound.setQuantity(
                    creationDTO.getQuantity() < productFound.getQuantity() ? cartItemFound.getQuantity() :
            ...
            cartItemFound.setQuantity(
                    cartItemFound.getQuantity() + creationDTO.getQuantity() < productFound.getQuantity() ?
                                ...
                                () ->
                                        new ResourceNotFoundException(
                                                String.format(
                                                        ...
                                                        "ID",
                                                        id)));
        if (Objects.equals(userFound.getId(),
                           cartItemFound.getUser().getId()) || userFound.getRole() == ERole.ROLE_ADMIN) {
            cartItemFound.setQuantity(
                    cartItemFound.getQuantity() + creationDTO.getQuantity() < productFound.getQuantity() ?
                            cartItemFound.getQuantity() + creationDTO.getQuantity() :
                            productFound.getQuantity());
