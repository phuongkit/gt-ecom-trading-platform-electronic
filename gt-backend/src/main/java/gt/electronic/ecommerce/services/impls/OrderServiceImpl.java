...
//    }
        ...
        Set<OrderShop> orderShops =
                this.orderItemMapper.orderDetailCreationDTOsToGroupOrderItemByShops(savedEntity,
            ...
            for (Long discountId : creationDTO.getDiscountIds()) {
                ...
                try {
                    if (discountFound != null && Utils.checkValidDiscount(discountFound)) {
                        OrderShop orderShop =
                                Utils.getOrderShopFromList(orderShops, discountFound.getShop(), savedEntity);
    ...
    public OrderResponseDTO updatePaymentOrder(
        ...
        if (entityFound.getUser() == null || Objects.equals(userFound.getId(),
            ...
            entityFound.setStatus(updatePaymentDTO.getStatus() == null ?
                                          (updatePaymentDTO.getPayment().ordinal() > 0 ?
                                                  EOrderStatus.ORDER_AWAITING_PAYMENT :
