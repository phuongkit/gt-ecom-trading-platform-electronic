...
public class ShopServiceImpl implements ShopService {
  ...
  @Override public ShopResponseDTO getShopBySlug(String slug) {
  ...
  @Override public ShopResponseDTO getShopByAccessToken(String accessToken) {
  ...
  @Override public ShopResponseDTO registerShop(User user) {
//    this.LOGGER.info(
//        String.format(
...
//    newEntity.setDescription(creationDTO.getDescription());
  ...
  @Override public ShopResponseDTO createShop(
    ...
    if (avatarFile != null && !avatarFile.isEmpty()) {
      Image image =
          this.imageService.createImageByMultipartFile(avatarFile, EImageType.IMAGE_SHOP);
      newEntity.setAvatar(image);
    }
    // set background
    if (backgroundFile != null && !backgroundFile.isEmpty()) {
      Image image =
          this.imageService.createImageByMultipartFile(backgroundFile, EImageType.IMAGE_SHOP_BACKGROUND);
