...
public class VNPayServiceImpl implements VNPayService {
    ...
    public PaymentUrlResponseDTO getPaymentUrlVNPay(String ipAddress, VNPayCreationDTO creationDTO)
        ...
        PaymentHistory paymentHistory =
                new PaymentHistory(vnp_OrderInfo, creationDTO.getFullName(), creationDTO.getOrderId(), creationDTO.getTotalPrice(),
                                   EPaymentCategory.ORDER, EPaymentType.VNPAY, vnp_TxnRef);
        ...
        vnp_Params.put("vnp_Amount", String.valueOf(creationDTO.getTotalPrice().multiply(new BigDecimal("100")).toBigInteger()));
