...
//        "{\"from_district_id\": 1454,\"service_id\": 53320,\"service_type_id\": null,\"to_district_id\": 1452,\"to_ward_code\": \"21012\",\"height\": 50,\"length\": 20,\"weight\": 200,\"width\": 20,\"insurance_value\": 10000,\"coupon\": null}";
...
//    }
  ...
  public String getDistrictId(String provinceId, String districtString) throws IOException {
    if (!Objects.equals(provinceId, "")) {
      URL url =
          new URL("https://online-gateway.ghn.vn/shiip/public-api/master-data/district?province_id=" +
                      provinceId);
      HttpURLConnection connection = (HttpURLConnection) url.openConnection();
      connection.setRequestMethod("GET");
      connection.setRequestProperty("Token", tokenGHN);
...
//    }
  ...
  public String getWardId(String districtId, String wardString) throws IOException {
    if (!Objects.equals(districtId, "")) {
      URL url =
          new URL("https://online-gateway.ghn.vn/shiip/public-api/master-data/ward?district_id=" +
                      districtId);
      HttpURLConnection connection = (HttpURLConnection) url.openConnection();
      connection.setRequestMethod("GET");
      connection.setRequestProperty("Token", tokenGHN);
