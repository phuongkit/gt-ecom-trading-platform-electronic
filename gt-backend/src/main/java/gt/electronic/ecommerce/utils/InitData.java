...
@Component public class InitData {
  ...
  private int createProduct(
    ...
    products[i] = new Product("Samsung Galaxy M93", new BigDecimal(12490000), 1000L, cv.categoryPhone, bv.brandSamsung,
    ...
    products[i] =
        new Product("IPhone 13 Pro Max 128GB", new BigDecimal(29190000), 1000L, cv.categoryPhone, bv.brandIphone,
    ...
    products[i] =
        new Product("Apple Watch S6 40mm viền nhôm dây silicone", new BigDecimal(8991000), 1000L, cv.categoryWatch,
    ...
    products[i] = new Product("Samsung Galaxy Watch 4 40mm Vàng Hồng", new BigDecimal(5490000), 1000L, cv.categoryPhone,
    ...
    products[i] = new Product("AVA+ DS005-PP", new BigDecimal(4790000), 1000L, cv.categoryBackupCharger, bv.brandOther,
    ...
    products[i] = new Product("Hydrus PA CK01", new BigDecimal(4790000), 1000L, cv.categoryBackupCharger, bv.brandOther,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] =
        new Product("MSI Modern 14 B11MOU i3 1115G4 (1027VN)", new BigDecimal(14490000), 1000L, cv.categoryLaptop,
    ...
    products[i] =
        new Product("Apple Watch Series 7 GPS 41mm", new BigDecimal(8590000), 1000L, cv.categoryWatch, bv.brandApple,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("Loa Bluetooth Mozard X21", new BigDecimal(7590000), 1000L, cv.categoryLoudSpeaker, bv.brandMozard,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] = new Product("Webcam 480P A4Tech PK-710G Đen", new BigDecimal(3490000), 1000L, cv.categoryCamera,
    ...
    products[i] = new Product("Bút cảm ứng S Pen Pro EJ-P5450 Đen", new BigDecimal(2490000), 1000L, cv.categoryBumper,
                              bv.brandOther, shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("Tai nghe Bluetooth True Wireless Galaxy Buds Live R180 Gold", new BigDecimal(3490000), 1000L,
    ...
    products[i] =
        new Product("Samsung Galaxy Z Flip3 5G", new BigDecimal(13490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] =
        new Product("Samsung Galaxy Z Flip3 5G Flex Your Way", new BigDecimal(13490000), 1000L, cv.categoryPhone,
                    bv.brandSamsung, shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Samsung Galaxy A32", new BigDecimal(14490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
                              Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy S22+ 5G", new BigDecimal(19490000), 1000L, cv.categoryPhone, bv.brandSamsung,
    ...
    products[i] = new Product("Samsung Galaxy A13", new BigDecimal(13490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                              Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy S21 FE 5G", new BigDecimal(23490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy S22 5G", new BigDecimal(23490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Samsung Galaxy M53", new BigDecimal(13490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationCanTho,
                              Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy Tab S8", new BigDecimal(13490000), 1000L, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Alcatel 3T8", new BigDecimal(3490000), 1000L, cv.categoryChargingCable, bv.brandOther,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] =
        new Product("IPad Pro M1 11 Inch 5G", new BigDecimal(13490000), 1000L, cv.categoryTablet, bv.brandApple,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("IPad Pro M1 11 Inch 8G", new BigDecimal(13490000), 1000L, cv.categoryTablet, bv.brandApple,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("surasj24jb7ut26fn6i2o248gtt33q0c.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Macbook 245 G8 R5 5500U (61C65PA)", new BigDecimal(33490000), 1000L, cv.categoryLaptop,
    ...
    products[i] = new Product("Đồng hồ CITIZEN 30 mm Nam NH8391-51X", new BigDecimal(13490000), 1000L, cv.categoryWatch,
    ...
    products[i] = new Product("Đồng hồ CITIZEN 32 mm Nam NH8391-51E", new BigDecimal(13490000), 1000L, cv.categoryWatch,
    ...
    products[i] = new Product("Đồng hồ CITIZEN 30 mm Nam NJ0084-59A", new BigDecimal(18490000), 1000L, cv.categoryWatch,
    ...
    products[i] = new Product("Đồng hồ ESPRIT 32 mm Nữ ES1L336L0035", new BigDecimal(16490000), 1000L, cv.categoryWatch,
    ...
    products[i] =
        new Product("Đồng hồ DKNY 30 mm Nữ NY2915", new BigDecimal(14490000), 1000L, cv.categoryWatch, bv.brandDKNY,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
