...
/**
 * @author minh phuong
 * @created 08/10/2022 - 9:46 PM
 */
@Component public class InitData {
  ...
  @Autowired private ShippingMethodRepository shippingMethodRepo;
  ...
  public void Init() {
    ...
    int maxIndexShop = createShop(shops, uv.customers, uv.maxIndexCustomer, rv, fullAddresses, maxIndexFullAddress);
    ...
    int maxIndexMainComment =
        createMainComments(mainComments, products, maxIndexProduct, uv.customers, uv.maxIndexCustomer);

    Comment[] childComments = new Comment[500];
    int maxIndexChildComment =
        createChildComments(childComments, mainComments, maxIndexMainComment, uv.customers, uv.maxIndexCustomer);

    Feedback[] mainFeedbacks = new Feedback[500];
    int maxIndexMainFeedback =
        createMainFeedbacks(mainFeedbacks, products, maxIndexProduct, uv.customers, uv.maxIndexCustomer);
    ...
    ShippingMethod shippingMethodGHTK = new ShippingMethod(EShippingMethod.GIAOHANGTIETKIEM, "", "");
  ...
  private int createDiscount(Discount[] discounts, Shop[] shops, int maxIndexShop) {
    ...
    List<Double> percents = Arrays.asList(0.11d, 0.15d, 0.25d, 0.30d, 0.33d, 0.39d, 0.49d, 0.50d, 0.59d, 1.00d);
    List<BigDecimal> prices =
        Arrays.asList(new BigDecimal(15000),
                      new BigDecimal(20000),
                      new BigDecimal(30000),
  ...
  private int createShop(
      Shop[] shops, User[] customers, int maxIndexCustomer, RoleVariable rv, FullAddress[] fullAddresses,
      int maxIndexFullAdress
  ) {
    int i = 0;
    customers[i].setRole(rv.roleSeller);
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] = new Shop("SAMISO OFFICIAL", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
    ...
    customers[i].setRole(rv.roleSeller);
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] = new Shop("Balo Chuối", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
    ...
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] =
        new Shop("Phụ Kiện Điện Thoại 123@", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
    ...
    customers[i].setRole(rv.roleSeller);
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] = new Shop("Zulia's Shop", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
    ...
    customers[i].setRole(rv.roleSeller);
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] = new Shop("BINTECH 27", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
    ...
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] =
        new Shop("MEKAXO - PHỤ KIỆN CÔNG NGHỆ", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
    ...
    customers[i].setRole(rv.roleSeller);
    customers[i] = this.userRepo.save(customers[i]);
    shops[i] = new Shop("SenBenBao.vn", customers[i], fullAddresses[generator.nextInt(maxIndexFullAdress + 1)],
  ...
  private int createSale(
    ...
    Set<Product> productSet2 =
        this.productRepo.findAllByCategory(cv.categoryPhone, pageable).stream().collect(Collectors.toSet());
    productSet2.addAll(
        this.productRepo.findAllByCategory(cv.categoryLaptop, pageable).stream().collect(Collectors.toSet()));
    productSet2.addAll(
        this.productRepo.findAllByCategory(cv.categoryAccessory, pageable).stream().collect(Collectors.toSet()));
    i++;
    sales[i] =
    ...
    Set<Product> productSet3 =
        this.productRepo.findAllByCategory(cv.categoryWatch, pageable).stream().collect(Collectors.toSet());
    productSet3.addAll(
        this.productRepo.findAllByCategory(cv.categorySmartWatch, pageable).stream().collect(Collectors.toSet()));
    ...
    Set<Product> productSet4 =
        this.productRepo.findAllByBrand(bv.brandSamsung, pageable).stream().collect(Collectors.toSet());
    i++;
  ...
  private int createProduct(
    ...
    products[i] = new Product("Samsung Galaxy M93", new BigDecimal(12490000), 1000, cv.categoryPhone, bv.brandSamsung,
    ...
    products[i] =
        new Product("IPhone 13 Pro Max 128GB", new BigDecimal(29190000), 1000, cv.categoryPhone, bv.brandIphone,
    ...
    products[i] =
        new Product("Apple Watch S6 40mm viền nhôm dây silicone", new BigDecimal(8991000), 1000, cv.categoryWatch,
    ...
    products[i] = new Product("Samsung Galaxy Watch 4 40mm Vàng Hồng", new BigDecimal(5490000), 1000, cv.categoryPhone,
    ...
    products[i] = new Product("Pin sạc dự phòng Polymer 10.000 mAh Type C PD QC3.0 Xmobile PowerSlim PJ JP21",
    ...
    products[i] = new Product("AVA+ DS005-PP", new BigDecimal(4790000), 1000, cv.categoryBackupCharger, bv.brandOther,
    ...
    products[i] = new Product("eValu PA F1 Air", new BigDecimal(4790000), 1000, cv.categoryBackupCharger, bv.brandOther,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] = new Product("Hydrus PA CK01", new BigDecimal(4790000), 1000, cv.categoryBackupCharger, bv.brandOther,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] = new Product("Pin sạc dự phòng Polymer 10.000 mAh Type C PD QC3.0 Xmobile PowerSlim PJ JP213",
                              new BigDecimal(4790000),
                              1000,
                              cv.categoryAccessory,
                              bv.brandXMobile,
    ...
    products[i] =
        new Product("MSI Modern 14 B11MOU i3 1115G4 (1027VN)", new BigDecimal(14490000), 1000, cv.categoryLaptop,
    ...
    products[i] =
        new Product("Apple Watch Series 7 GPS 41mm", new BigDecimal(8590000), 1000, cv.categoryWatch, bv.brandApple,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("Loa Bluetooth Mozard X21", new BigDecimal(7590000), 1000, cv.categoryLoudSpeaker, bv.brandMozard,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] = new Product("Webcam 480P A4Tech PK-710G Đen", new BigDecimal(3490000), 1000, cv.categoryCamera,
    ...
    products[i] = new Product("Bút cảm ứng S Pen Pro EJ-P5450 Đen", new BigDecimal(2490000), 1000, cv.categoryBumper,
                              bv.brandOther, shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("Tai nghe Bluetooth True Wireless Galaxy Buds Live R180 Gold", new BigDecimal(3490000), 1000,
                    cv.categoryAccessory, bv.brandSamsung, shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("Samsung Galaxy Z Flip3 5G", new BigDecimal(13490000), 1000, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] =
        new Product("Samsung Galaxy Z Flip3 5G Flex Your Way", new BigDecimal(13490000), 1000, cv.categoryPhone,
                    bv.brandSamsung, shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Samsung Galaxy A32", new BigDecimal(14490000), 1000, cv.categoryPhone, bv.brandSamsung,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
                              Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy S22+ 5G", new BigDecimal(19490000), 1000, cv.categoryPhone, bv.brandSamsung,
    ...
    products[i] = new Product("Samsung Galaxy A13", new BigDecimal(13490000), 1000, cv.categoryPhone, bv.brandSamsung,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                              Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy S21 FE 5G", new BigDecimal(23490000), 1000, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Samsung Galaxy S22 5G", new BigDecimal(23490000), 1000, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Samsung Galaxy M53", new BigDecimal(13490000), 1000, cv.categoryPhone, bv.brandSamsung,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationCanTho,
                              Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] =
        new Product("Acer TravelMate B3 31 P49D N5030 (NX.VNFSV.005)", new BigDecimal(3490000), 1000, cv.categoryLaptop,
    ...
    products[i] =
        new Product("Samsung Galaxy Tab S8", new BigDecimal(13490000), 1000, cv.categoryPhone, bv.brandSamsung,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("44uexhsraf1xm5mgenwxvubobjhpbgny.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Alcatel 3T8", new BigDecimal(3490000), 1000, cv.categoryChargingCable, bv.brandOther,
                              shop[generator.nextInt(maxIndexShop + 1)], lv.locationHaNoi,
    ...
    products[i] =
        new Product("IPad Pro M1 11 Inch 5G", new BigDecimal(13490000), 1000, cv.categoryTablet, bv.brandApple,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] =
        new Product("IPad Pro M1 11 Inch 8G", new BigDecimal(13490000), 1000, cv.categoryTablet, bv.brandApple,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
                    Image.createImageProduct("surasj24jb7ut26fn6i2o248gtt33q0c.jpg"), "");
    products[i] = this.productRepo.save(products[i]);
    ...
    products[i] = new Product("Macbook 245 G8 R5 5500U (61C65PA)", new BigDecimal(33490000), 1000, cv.categoryLaptop,
    ...
    products[i] = new Product("Đồng hồ CITIZEN 30 mm Nam NH8391-51X", new BigDecimal(13490000), 1000, cv.categoryWatch,
    ...
    products[i] = new Product("Đồng hồ CITIZEN 32 mm Nam NH8391-51E", new BigDecimal(13490000), 1000, cv.categoryWatch,
    ...
    products[i] = new Product("Đồng hồ CITIZEN 30 mm Nam NJ0084-59A", new BigDecimal(18490000), 1000, cv.categoryWatch,
    ...
    products[i] = new Product("Đồng hồ ESPRIT 32 mm Nữ ES1L336L0035", new BigDecimal(16490000), 1000, cv.categoryWatch,
    ...
    products[i] =
        new Product("Đồng hồ DKNY 30 mm Nữ NY2915", new BigDecimal(14490000), 1000, cv.categoryWatch, bv.brandDKNY,
                    shop[generator.nextInt(maxIndexShop + 1)], lv.locationHCM,
    ...
    products[i] = this.productRepo.save(products[i]);
    products[i].setImageGallery(new HashSet<>(this.imageRepo.saveAllAndFlush(Image.createImageProductGallery(new String[]{
    ...
    i++;
    products[i] =
        new Product("Laptop MSI Modern 14 B11MOU i3 1115G4/8GB/256GB/14\"F/Win11/(1027VN)/Xám - Hàng chính hãng",
    ...
    descriptions = new HashMap<>();
    descriptions = Stream.of(new String[][]{
        {"Thương hiệu", "MSI"}, {"Xuất xứ thương hiệu", "Đài Loan"}, {"Xuất xứ", "Trung Quốc"},
    }).collect(Collectors.toMap(data -> data[0], data -> data[1]));
    this.productService.createDescription(products[i], descriptions);
    ...
    descriptions = new HashMap<>();
    descriptions = Stream.of(new String[][]{
        {"Thương hiệu", "Acer"}, {"Xuất xứ thương hiệu", "Trung Quốc"}, {"Xuất xứ", "Trung Quốc"},
    }).collect(Collectors.toMap(data -> data[0], data -> data[1]));
    this.productService.createDescription(products[i], descriptions);
    ...
    descriptions = new HashMap<>();
    descriptions = Stream.of(new String[][]{
        {"Thương hiệu", "Hòa Phát"}, {"Xuất xứ thương hiệu", "Việt Nam"}, {"Xuất xứ", "Việt Nam"},
    }).collect(Collectors.toMap(data -> data[0], data -> data[1]));
    this.productService.createDescription(products[i], descriptions);
    ...
    descriptions = Stream.of(new String[][]{
        ...
        {"Số lượng loa", "2"},
        {"Công nghệ âm thanh", "AI Sound / Pro, AI Acoustic Tuning, Clear Voice III, Sound Alive, Sound Mode Sync"},
        {"Thương hiệu", "LG"},
    ...
    descriptions = Stream.of(new String[][]{
        ...
        {"Số lượng loa", "2"},
        {"Công nghệ âm thanh", "Dolby Digital Plus, Dolby 5.1 Decoder, Object Tracking Sound, Q-Symphony"},
        {"Thương hiệu", "Samsung"},
        {"Xuất xứ thương hiệu", "Hàn Quốc"},
        {"Composite video", "1"},
    ...
    descriptions = Stream.of(new String[][]{
        ...
        {"Thương hiệu", "TCL"},
        {"Xuất xứ thương hiệu", "Trung Quốc"},
        {"Điều khiển tivi bằng điện thoại", "màn hình Chromecast, Chiếu màn hình Screen Mirroring"},
        {"Tần số quét", "60 Hz"},
        ...
        {"Năm ra mắt", "2019"},
        {"Hình ảnh", "Full HD"},
        {"Kích thước không chân/treo tường", "Không chân: Ngang 90.1 cm - Cao 51.63 cm - Dày 7.5 cm"},
    ...
    products[i].setImageGallery(new HashSet<>(this.imageRepo.saveAllAndFlush(
        Image.createImageProductGallery(
            new String[]{
                ...
                "c03bc98bda3def220228fb86364a05f7.jpg",
            }))));
    products[i] = this.productRepo.save(products[i]);
    descriptions = new HashMap<>();
    descriptions = Stream.of(new String[][]{
    ...
    products[i] =
        new Product(
            "Google Tivi Coocaa HD 32 Inch - 32Z72 Youtube Netfilx Smart TV 2022 new tv - Hàng Chính Hãng",
    ...
    products[i] =
        new Product(
            "Google Tivi Sony 4K 65 inch KD-65X75K - Model 2022",
    ...
    descriptions = Stream.of(new String[][]{
        ...
        {"Công nghệ xử lý hình ảnh", "Bộ xử lý X1 4K HDR, Chuyển động mượt Motionflow XR 200"},
        {"Model", "KD-65X75K"},
        {"Cổng HDMI", "4"},
        {"Cổng internet (LAN)", "Có"},
        {"Wifi", "Có"},
        ...
        {"Loại Tivi", "Google tivi"},
        {"Các ứng dụng sẵn có", "Clip TV, FPT Play, Galaxy Play (Fim+), Netflix, VieON, VTVcab ON, YouTube"},
        {"USB", "2"},
    ...
    descriptions = new HashMap<>();
    descriptions = Stream.of(new String[][]{
        {"Thương hiệu", "Samsung"}, {"Xuất xứ thương hiệu", "Việt Nam"}, {"Xuất xứ", "Việt Nam"},
    }).collect(Collectors.toMap(data -> data[0], data -> data[1]));
    this.productService.createDescription(products[i], descriptions);
    ...
    products[i] =
        new Product(
            "Google Tivi Sony 4K 55 inch KD-55X75K - Model 2022",
    ...
    products[i] =
        new Product(
            "Google Tivi Sony 2K 32 inch KD-32W830K - Model 2022",
    ...
    descriptions = Stream.of(new String[][]{
        ...
        {"Wifi", "Có"},
        {"Xuất xứ", "Việt Nam"},
        {"Remote thông minh", "Điều khiển tivi bằng giọng nói với One Remote, hỗ trợ trợ lý ảo Bixby"},
        {"Độ phân giải", "UHD 4K (3840 x 2160)"},
        {"Kích thước màn hình", "43 inch"},
    ...
    descriptions = new HashMap<>();
    descriptions = Stream.of(new String[][]{
        {"Thương hiệu", "coocaa"}, {"Xuất xứ thương hiệu", "Việt Nam"}, {"Xuất xứ", "Việt Nam"},
    }).collect(Collectors.toMap(data -> data[0], data -> data[1]));
    this.productService.createDescription(products[i], descriptions);
...
//    this.productService.createDescription(products[i], descriptions);
  ...
  private int createMainComments(
    ...
    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "What’s up?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "How’s it going?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[1], customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "What have you been doing?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[1], customers[generator.nextInt(maxIndexCustomer + 1)], "Is that so?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[1], customers[generator.nextInt(maxIndexCustomer + 1)], "How come?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[1], customers[generator.nextInt(maxIndexCustomer + 1)], "How old are you?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[3], customers[generator.nextInt(maxIndexCustomer + 1)], "How are you?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[3], customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Where are you coming from?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[2], customers[generator.nextInt(maxIndexCustomer + 1)], "Can I help you?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[2], customers[generator.nextInt(maxIndexCustomer + 1)], "finish");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "Can I help you?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "Are you okay?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "Where do you live?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The campaign was launched in an effort to raise product visibility.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Infobyte Corporation will hold a party in celebration of its anniversary.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The printer will be delivered on schedule.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Passengers should claim their baggage on arrival.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Ms. Ki will write the letter on behalf of Crystal Incorporated.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The product manual’s instructions are clear and to the point.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Helmets must be worn in compliance with safety regulations.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The bank experienced financial problems at first.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "You may participate in the workshop of your choice.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Creole Incorporated works in conjunction with Lope Limited.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Proposals must be submitted by January 22 at the latest.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Feel free to send a message in reply.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The French branch was closed as a result of the reduced budget.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Researchers will release the results in a timely manner.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Mr. Powell will lead the team in the manager’s absence.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be appreciative of");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Management was appreciative of the contribution made by the team.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be advantageous for");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The country’s low tax rates are advantageous for owners of large international firms.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be suitable for");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "This venue is suitable for holding a retirement party.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be responsible for");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Mr Hobbs is responsible for budget allocation.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be subject to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Overseas orders are subject to higher shipping rates.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The director is concerned about office security.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Most of the workers are native to other cities.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The software is compatible with all office computers.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The manager is eligible for a promotion.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be native to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be compatible with");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be eligible for");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be about to ");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "George Payne’s book is about to be released.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be absent from");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The keynote speaker was absent from the seminar.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be willing to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be grateful for");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Mr. Han was grateful for his staff’s hard work.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be interested in");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "The technicians are interested in an annual workshop.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be pleased to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "El Ristorante is pleased to announce its new menu.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be honored for");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Ms. Fitz was honored for her managerial skills.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be superior to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Culver’s furniture is superior to that of other brands.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be comparable to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "This theatrical performance is comparable to the one from last year.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be uncertain about");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Ms. Lee is uncertain about the cost of renovation.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);

    i++;
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "be eager to");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)],
                                   "Sirenn Incorporated is eager to start the hotel construction.");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
    ...
    mainComments[i] = new Comment();
    mainComments[i].setMainComment(products[generator.nextInt(maxIndexProduct + 1)],
                                   customers[generator.nextInt(maxIndexCustomer + 1)], "What have you been doing?");
    mainComments[i] = this.commentRepo.save(mainComments[i]);
  ...
  private int createChildComments(
    ...
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "How do you do?");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "at all times");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "at least");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in advance");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in response to ");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in an effort to");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in celebration of ");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in the event of");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "on schedule");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "on arrival");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "on behalf of");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "to the point");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in compliance with ");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "at first");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "of one’s choice");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in conjunction with");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "at the latest");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in reply");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "as a result of");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in a timely manner");
    childComments[i] = this.commentRepo.save(childComments[i]);

    i++;
    childComments[i] = new Comment();
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)], "in one’s absence");
    childComments[i] = this.commentRepo.save(childComments[i]);
    ...
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)],
                                     "Passengers must stay seated at all times during takeoff.");
    childComments[i] = this.commentRepo.save(childComments[i]);
    ...
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)],
                                     "All staff must attend at least three seminars.");
    childComments[i] = this.commentRepo.save(childComments[i]);
    ...
    childComments[i].setChildComment(mainComments[generator.nextInt(maxIndexMainComment + 1)],
                                     customers[generator.nextInt(maxIndexCustomer + 1)],
                                     "The increased output was in response to high demand.");
    childComments[i] = this.commentRepo.save(childComments[i]);
  ...
  private int createMainFeedbacks(
    ...
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "I got it",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "No way!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] =
        new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "This is too good to be true!",
                     (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] =
        new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "I can't say for sure.",
                     (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] =
        new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "There's no way to know.",
                     (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "I guess so.",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] =
        new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "You better believe it!",
                     (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "Of course!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "Definitely!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "Absolutely!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[0], customers[generator.nextInt(maxIndexCustomer + 1)], "How come?",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)],
                                    "Is that so?",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "It's none of your business.",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "Please go first. After you.",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "What the hell are you doing?",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "I know I can count on you.",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "Beggars can’t be choosers!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "Have I got your word on that?",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "You‘ll have to step on it.",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "What the hell is going on?",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "It’s a kind of once-in-life!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);

    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "Out of sight, out of mind!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "This is too good to be true!",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
    ...
    i++;
    mainFeedbacks[i] = new Feedback(products[generator.nextInt(maxIndexProduct + 1)],
                                    customers[generator.nextInt(maxIndexCustomer + 1)], "You'd better stop dawdling.",
                                    (int) (Math.random() * 5 + 1));
    mainFeedbacks[i] = this.feedbackRepo.save(mainFeedbacks[i]);
  ...
  private int createChildFeedbacks(
    ...
    childFeedbacks[i] = new Comment();
    childFeedbacks[i].setChildFeedback(mainFeedbacks[generator.nextInt(maxIndexMainFeedback + 1)],
                                       customers[generator.nextInt(maxIndexCustomer + 1)], "The more, the merrier!");
    childFeedbacks[i] = this.commentRepo.save(childFeedbacks[i]);
    ...
    childFeedbacks[i] = new Comment();
    childFeedbacks[i].setChildFeedback(mainFeedbacks[generator.nextInt(maxIndexMainFeedback + 1)],
                                       customers[generator.nextInt(maxIndexCustomer + 1)], "Give me a certain time!");
    childFeedbacks[i] = this.commentRepo.save(childFeedbacks[i]);
    ...
    childFeedbacks[i] = new Comment();
    childFeedbacks[i].setChildFeedback(mainFeedbacks[generator.nextInt(maxIndexMainFeedback + 1)],
                                       customers[generator.nextInt(maxIndexCustomer + 1)], "I was just daydreaming.");
    childFeedbacks[i] = this.commentRepo.save(childFeedbacks[i]);
    ...
    childFeedbacks[i] = new Comment();
    childFeedbacks[i].setChildFeedback(mainFeedbacks[generator.nextInt(maxIndexMainFeedback + 1)],
                                       customers[generator.nextInt(maxIndexCustomer + 1)], "You better believe it!");
    childFeedbacks[i] = this.commentRepo.save(childFeedbacks[i]);
    ...
    childFeedbacks[i] = new Comment();
    childFeedbacks[i].setChildFeedback(mainFeedbacks[generator.nextInt(maxIndexMainFeedback + 1)],
                                       customers[generator.nextInt(maxIndexCustomer + 1)], "There’s no way to know.");
    childFeedbacks[i] = this.commentRepo.save(childFeedbacks[i]);
  ...
  public void createCategory(CategoryVariable cv, BrandVariable bv) {
    ...
    Set<Brand> brandPhones = new HashSet<>(
        Arrays.asList(bv.brandIphone, bv.brandSamsung, bv.brandOppo, bv.brandXiaomi, bv.brandVivo, bv.brandRealme,
                      bv.brandNokia, bv.brandMobell, bv.brandItel, bv.brandMasstel));
    cv.categoryPhone = new Category("Điện Thoại", Image.createImageCategory("498ugyugr9ykbnveumsa86b5wc6e0qkt.png")
    ...
    Set<Brand> brandLaptops = new HashSet<>(
        Arrays.asList(bv.brandMacbook, bv.brandAsus, bv.brandHP, bv.brandLenovo, bv.brandAcer, bv.brandDell,
                      bv.brandMSI, bv.brandItel));
    cv.categoryLaptop = new Category("Laptop", Image.createImageCategory("usq395chzsb8zxm5twkb04sir1w8z1ah.png")
    ...
    Set<Brand> brandTablets = new HashSet<>(
        Arrays.asList(bv.brandIpad, bv.brandSamsung, bv.brandXiaomi, bv.brandOppo, bv.brandLenovo, bv.brandMasstel,
                      bv.brandNokia, bv.brandHuawei));
    cv.categoryTablet =
        new Category("Máy Tính Bảng", Image.createImageCategory("d1easb1ubyaf0rjgawucpkv9hd1464rc.png")
    ...
    Set<Brand> brandAccessories = new HashSet<>(
        Arrays.asList(bv.brandApple, bv.brandSamsung, bv.brandSony, bv.brandLG, bv.brandFPT, bv.brandMicrosoft,
    ...
    Set<Brand> brandSmartWatch = new HashSet<>(
        Arrays.asList(bv.brandWatch, bv.brandSamsung, bv.brandXiaomi, bv.brandOppo, bv.brandRealme, bv.brandMasstel,
                      bv.brandAsus, bv.brandItel));
    cv.categorySmartWatch =
        new Category("Đồng Hồ Thông Minh", Image.createImageCategory("bt81mbkyr335bj7oy8b19jy1i8z6tsgi.png")
    ...
    Set<Brand> brandWatchs = new HashSet<>(
        Arrays.asList(bv.brandCasio, bv.brandOrient, bv.brandCitizen, bv.brandMovado, bv.brandFossil, bv.brandGShock,
                      bv.brandELIO, bv.brandMVW, bv.brandNakzen, bv.brandEsprit, bv.brandDKNY));
    cv.categoryWatch = new Category("Đồng Hồ", Image.createImageCategory("co54eesb7422xielx80uysc0umbweg26.png")
    ...
    Set<Brand> brandPCPrinter = new HashSet<>(
        Arrays.asList(bv.brandApple, bv.brandHP, bv.brandAsus, bv.brandMSI, bv.brandLenovo, bv.brandDell));
    ...
    Set<Brand> brandSims =
        new HashSet<>(Arrays.asList(bv.brandViettel, bv.brandVietNamMobile, bv.brandVinaPhone, bv.brandMobiPhone));
    ...
    Set<Brand> brandNetworks = new HashSet<>(
        Arrays.asList(bv.brandTPLink, bv.brandTenda, bv.brandLinkSYS, bv.brandToToLink, bv.brandXiaomi, bv.brandAsus,
    ...
    cv.categoryBumper =
        new Category("Ốp Lưng", Image.createImageCategory("ax01oeggq8usqsmjz5mdnxtuxaod7814.png"), null, brandBumpers);
    cv.categoryBumper.setParentCategory(cv.categoryAccessory);
    cv.categoryBumper = this.categoryRepo.save(cv.categoryBumper);

    Set<Brand> brandMouses = new HashSet<>(Arrays.asList(bv.brandLogitech, bv.brandAsus, bv.brandMicrosoft));
    ...
    cv.categoryLoudSpeaker =
        new Category("Loa", Image.createImageCategory("olek7max5x8vlk0pn1l6ud5uhizwgdh0.png"), null, brandLoudSpeakers);
    ...
    Set<Brand> brandHeadPhones =
        new HashSet<>(Arrays.asList(bv.brandApple, bv.brandSony, bv.brandSamsung, bv.brandMozard));
    ...
    Set<Brand> brandCharginCables = new HashSet<>(
        Arrays.asList(bv.brandApple, bv.brandSamsung, bv.brandAnker, bv.brandXMobile, bv.brandOppo, bv.brandBelkin,
                      bv.brandSony));
    ...
    Set<Brand> brandComputerSets =
        new HashSet<>(Arrays.asList(bv.brandApple, bv.brandHP, bv.brandAsus, bv.brandLenovo, bv.brandMSI));
    ...
    cv.categoryPrinter =
        new Category("Máy In", Image.createImageCategory("q19in86smktb2xhfjz3q7cuvc6il0gwx.png"), null, brandPrinters);
    ...
    Set<Brand> brandComputerScreens = new HashSet<>(
        Arrays.asList(bv.brandAsus, bv.brandSamsung, bv.brandLenovo, bv.brandViewSonic, bv.brandDell, bv.brandMSI));
    ...
    cv.categoryCamera =
        new Category("Camera, Webcam", Image.createImageCategory("9s0n62iw3w68p2uymk2fpjp6dh28p5mr.png"), null, null);
    cv.categoryCamera.setParentCategory(cv.categoryAccessory);
    cv.categoryCamera = this.categoryRepo.save(cv.categoryCamera);

    Set<Brand> brandSmartHouses =
        new HashSet<>(Arrays.asList(bv.brandApple, bv.brandXiaomi, bv.brandFPT, bv.brandTPLink));
    ...
    Set<Brand> brandRefrigerators =
        new HashSet<>(Arrays.asList(bv.brandSamsung, bv.brandPanasonic, bv.brandSharp, bv.brandAqua,
                                    bv.brandHitaChi,
                                    bv.brandHoaPhat,
                                    bv.brandElectrolux));
    cv.categoryRefrigerator =
        new Category("Tủ lạnh", Image.createImageCategory("download.jpg"), null, brandRefrigerators);
    ...
    Set<Brand> brandTivis = new HashSet<>(Arrays.asList(bv.brandLG, bv.brandSamsung, bv.brandCoocaa,
                                                        ...
                                                        bv.brandAsanzo));
    cv.categoryTivi =
        new Category("Tivi", Image.createImageCategory("television-logo-design_412311-3881.webp"), null, brandTivis);
...
//    cv.category = this.categoryRepo.save(cv.category);
  ...
  public void createBrand(BrandVariable bv) {
    ...
    bv.brandMicrosoft = new Brand("Microsoft", Image.createImageBrand("2msdtvpz5rxw5tb8zfvuduwb6d166tdz.jpg"));
    bv.brandMicrosoft = this.brandRepo.save(bv.brandMicrosoft);

    bv.brandLogitech = new Brand("Logitech", Image.createImageBrand("i163w9o5tev99i7bt29wytw6a0c2qjw6.jpg"));
    ...
    bv.brandPanasonic = new Brand("Panasonic", Image.createImageBrand("99ihqv46ybzjky6c3xq2sdzvq26f04xr.png"));
    bv.brandPanasonic = this.brandRepo.save(bv.brandPanasonic);

    bv.brandSharp = new Brand("Sharp", Image.createImageBrand("2560px-Logo_of_the_Sharp_Corporation.svg.png"));
    ...
    bv.brandVietNamMobile = new Brand("VietNamMobile", Image.createImageBrand("vbp16shygohse0z827hgjwncwlhooqxy.png"));
    ...
    bv.brandMobiPhone = new Brand("MobiPhone", Image.createImageBrand("uy721spxh2d5vrn0p2q7j148c9pgt967.png"));
    bv.brandMobiPhone = this.brandRepo.save(bv.brandMobiPhone);

    bv.brandVinaPhone = new Brand("VinaPhone", Image.createImageBrand("l2f1eryngcqms4g8cvl8xik1xloskcw8.png"));
    ...
    bv.brandViewSonic = new Brand("View Sonic", Image.createImageBrand("cyx4qgygqehamx7zvilvmr6tu4x6qdfx.png"));
    ...
    bv.brandMercuSYS = new Brand("Mercu SYS", Image.createImageBrand("pfpfsghoe1c5rgwxmjx8rgvqcxw6n28l.jpg"));
    ...
    bv.brandToToLink = new Brand("ToTo Link", Image.createImageBrand("lj2f99hzbd63xdt5zmlvw9g8srylwf3e.jpg"));
...
//    bv.brand = this.brandRepo.save(bv.brand);
  ...
  public void createUser(UserVariable uv, RoleVariable rv, LocationVariable lv) {
    AuthRegisterDTO authAdmin1 =
        new AuthRegisterDTO("Thái", "Phương", EGender.MALE, "0375189189", "admin@gmail.com", Utils.DEFAULT_PASSWORD);
    ...
    AuthRegisterDTO authAdmin2 =
        new AuthRegisterDTO("Nguyễn", "Nguyên", EGender.MALE, "0976080909", "admin1@gmail.com", Utils.DEFAULT_PASSWORD);
  ...
  public void createRole(RoleVariable rv) {
    ...
    rv.roleCustomer = new Role(ERole.ROLE_CUSTOMER,
    ...
    rv.roleEditor = new Role(ERole.ROLE_EDITOR, "Manage categories, bv.brands, products, articles and menus");
    rv.roleEditor = this.roleService.createRole(rv.roleEditor);

    rv.roleShipper = new Role(ERole.ROLE_SHIPPER, "View products, view orders and update order status");
    rv.roleShipper = this.roleService.createRole(rv.roleShipper);

    rv.roleSalesPerson =
        new Role(ERole.ROLE_SALESPERSON, "Manage product price, customers, shipping, orders and sales report");
