...
public class Image {
  ...
  public static Image createImageBrand(String name) {
    return name == null || Objects.equals(name, "") ? null : new Image(EImageType.IMAGE_BRAND + "/" + name, EImageType.IMAGE_BRAND);
  }

  public static Image createImageCategory(String name) {
    return name == null || Objects.equals(name, "") ? null : new Image(EImageType.IMAGE_CATEGORY + "/" + name, EImageType.IMAGE_CATEGORY);
  }

  public static Image createImageAvatarShop(String name) {
    return name == null || Objects.equals(name, "") ? null : new Image(EImageType.IMAGE_SHOP + "/" + name, EImageType.IMAGE_SHOP);
  }
