...
import { saveDiscountUser } from '../../../redux/discount/discountsApi';
function ShopInfo({props}) {
    ...
    const checklistDup=(id) =>{
        return listDup.find(item=>(item=== id))
    }
    ...
    const handleSaveDiscount=(code,id)=>{
        if(checklistDup(id)){
    ...
    <div className="container my-8">
        ...
        <div className="col-span-7">
                ...
                <div className="row flex flex-col gap-4">   
                    ...
                    {discountsShop.map((item,index)=>(
                        <div key={index} className="product-list col-span-12">
                        <div className="product-item flex gap-8">
                        
                            <div className="w-[170px] h-[170px]">
                               <img className='w-full h-full' src="https://png.pngtree.com/png-vector/20190227/ourlarge/pngtree-vector-voucher-icon-png-image_708692.jpg"></img>
                            </div>
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="">
                                    <p>Tối đa: {item.cappedAt}đ</p>
                                </div>
                                <div className="">
                                   <span className='text-gray-600'> {item.quantity}</span>
                                </div>
                                <div className="">
                                    <span>Tối thiểu mua từ: {item.minSpend}đ</span>
                                </div>
                                <div className="">
                                    <button onClick={()=>handleSaveDiscount(item.code,item.id)} type="button" class={checkColorBtnSave(item.id)}>Lưu</button>
                                </div>
                            </div>
            ...
            <div className="col-span-5">
                ...
                <div className="flex flex-col items-center justify-center ">
                    <div href="#" className="mb-2 w-full list-group-item text-orange-500 font-semibold text-center text-2xl">Vouncher đã lưu tại Shop</div>
                        {discountDuplicate().map((item,index)=>(
                            <div className='flex gap-8 items-center' key={index}>
                                <div className="image h-[40px] w-[40[px]">
                                    <a href="#"><img className='w-full h-full' src="https://png.pngtree.com/png-vector/20190227/ourlarge/pngtree-vector-voucher-icon-png-image_708692.jpg"></img></a>
                                </div>
